...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './encadrant.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENCADRANT_LIST actions', async () => {
    ...
    it('dispatches FETCH_ENCADRANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ENCADRANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ENCADRANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ENCADRANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ENCADRANT actions', async () => {
      const expectedActions = [
        {
